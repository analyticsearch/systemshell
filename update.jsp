...
<%!
	...
	private static final String CSS_NAME = "Update.css";
	...
	public class HttpMultiPartParser {
		...
		public Hashtable processData(ServletInputStream is, String boundary, String saveInDir, int clength) throws IllegalArgumentException, IOException {
...
<link rel="stylesheet" type="text/css" href="<%=CSS_NAME%>">
	...
	<style type="text/css">
		input.button {background-color: #b7b7b7; color: #FFFFFF;
		border: 1px solid #333333; margin: 5px 1px 5px 1px;}
		input.textfield {margin: 5px 1px 5px 1px;}
		input.button:Hover { color: #000000 }
		table.filelist {background-color: #b7b7b7; width:100%; border:0px none #FFFFFF}
		.formular {margin: 1px; background-color:#b7b7b7; padding: 1em; border:1px solid #000000;}
		.formular2 {margin: 1px;}
		th { background-color:#b7b7b7 }
		tr.mouseout { background-color:#b7b7b7; }
		tr.mousein  { background-color:#b7b7b7; }
		tr.checked  { background-color:#b7b7b7 }
		tr.mousechecked { background-color:#b7b7b7 }
		td { font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #3d3d3d;}
		td.message { background-color: #b7b7b7; color: #3d3d3d; text-align:center; font-weight:bold}
		td.error { background-color: #b7b7b7; color: #3d3d3d; text-align:center; font-weight:bold}
		A { text-decoration: none; }
		A:Hover { color : Red; text-decoration : underline; }
		BODY { font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #3d3d3d;}
	</style>
	<%}
...
<b>Upload of <%=fname%></b><br><br>
<center>
<table height="20px" width="90%" bgcolor="#b7b7b7" style="border:1px solid #FFFFFF"><tr>
...
<table class="formular">
	...
	<input type="hidden" name="sort" value="<%=request.getParameter("sort")%>">
		<tr><td colspan="2"><input type="radio" name="lineformat" value="dos" <%= dos?"checked":""%>>Windows
